 ...
 * @see ExportImportValidatorServiceHttp
 * @see ExportImportValidatorServiceUtil
 * @generated
 */
@ProviderType
public class ExportImportValidatorServiceSoap {
	public static com.liferay.exportimport.api.validator.ExportImportValidatorParameters getRemoteLayoutLarTypeExportImportValidatorParameters(
		...
		try {
			com.liferay.exportimport.api.validator.ExportImportValidatorParameters returnValue =
				ExportImportValidatorServiceUtil.getRemoteLayoutLarTypeExportImportValidatorParameters(groupId);
	...
	public static com.liferay.exportimport.api.validator.ExportImportValidatorParameters getBuildNumberExportImportValidatorParameters()
		...
		try {
			com.liferay.exportimport.api.validator.ExportImportValidatorParameters returnValue =
				ExportImportValidatorServiceUtil.getBuildNumberExportImportValidatorParameters();
	...
	public static void validate(java.lang.String className,
		...
		throws RemoteException {
		try {
			ExportImportValidatorServiceUtil.validate(className,
	...
	private static Log _log = LogFactoryUtil.getLog(ExportImportValidatorServiceSoap.class);
}
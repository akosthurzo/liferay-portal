...
public class StagedExpandoColumnImpl implements StagedExpandoColumn {
	...
	public Object clone() {
		...
		stagedExpandoColumn.setExpandoColumn(_expandoColumn);
		stagedExpandoColumn.setExpandoTableClassName(_expandoTableClassName);
		stagedExpandoColumn.setExpandoTableName(_expandoTableName);
	...
	public String getExpandoTableClassName() {
		return _expandoTableClassName;
	}

	@Override
	public String getExpandoTableName() {
		return _expandoTableName;
	}
